public class MessageStrings {
    ...
    static public String PRIVATE_KEY = "private_key";
    static public String POSITION = "position";
    static public String LEADERBOARD = "leaderboard";
    static public String BLOCKCHAIN_SCORE = "blockchain_score";
    static public String SEND_BEST_BLOCKCHAIN = "send_best_blockchain";
    static public String BLOCKCHAIN_OBJECT = "blockchain_object";
}
